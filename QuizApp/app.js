function login() {
    var localStorageValueSetEmail = localStorage.setItem('gmail', 'anas@gmail.com')
    var localStorageValueSetPass = localStorage.setItem('password', 'anas')
    ...
    // var localStorgeEmail = localStorage.getItem('email')
    // var localStorgePassword = localStorage.getItem('password')
